...
export default function Home() {
  ...
  const Sections = ({ link, title, description }: SectionProps) => {
    return (
      <div className="flex flex-col gap-2 border-b last:border-b-0 py-10 border-y-light-gray">
        ...
        <div className="flex justify-end items-end">
          <Link href={link}>
            <button className="flex flex-row items-center gap-2 py-2 px-4 bg-light-gray rounded-lg text-sm font-medium hover:bg-hover-light-gray transition duration-200 ease-in">
              Go To
              <FaArrowRight />
            </button>
          </Link>
    ...
    <main className="mt-10 p-6">
      <div className="mx-auto w-4/5 max-w-screen-lg">
        <Sections
          link="/quizify"
          title="Quizify"
          description="Create personalized quizzes from PDFs and text on any topic with our dynamic quiz generator."
        />
        <Sections
          link="/ai-pen"
          title="AI-Pen"
